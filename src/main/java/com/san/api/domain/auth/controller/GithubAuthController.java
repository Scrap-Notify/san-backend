...
public class GithubAuthController {
    ...
    @Operation(
            ...
            description = "백엔드가 state를 발급한 뒤 GitHub authorize 페이지로 리다이렉트합니다."
    )
     ...
     *
     * 프론트엔드가 직접 code를 전달하는 방식도 유지합니다.
     * => 로컬 테스트나 Postman 검증하기 위해서!
     * 추후 삭제할 예정
     */
    @Operation(
            summary = "GitHub 로그인",
    ...
    @Operation(
            ...
            description = "암호화 저장된 GitHub access token으로 사용자가 접근 가능한 저장소 목록을 조회합니다."
    )
    ...
    @Operation(
            ...
            description = "요청한 GitHub 저장소 ID가 실제 접근 가능한 저장소인지 검증한 뒤 연결합니다."
    )
    ...
    @Operation(
            ...
            description = "현재 서비스 계정에 연결된 GitHub 저장소 목록을 조회합니다."
    )
    ...
    @Operation(
            ...
            description = "현재 서비스 계정에 연결된 GitHub 저장소를 연결 해제합니다."
    )
